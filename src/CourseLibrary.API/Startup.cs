...
namespace CourseLibrary.API
{
    public class Startup
    {
        ...
        {
            services.AddHttpCacheHeaders((expirationModelOpetions) =>
            {
                expirationModelOpetions.MaxAge = 60;
                expirationModelOpetions.CacheLocation = Marvin.Cache.Headers.CacheLocation.Private;
            },
            (validationModelOpetion) =>
            {
                validationModelOpetion.MustRevalidate = true;
            }
            );
            ...
            services.AddDbContext<CourseLibraryContext>(options =>
            {
                options.UseSqlServer(
                    @"Server=DESKTOP-36NMA4Q;Database=CourseLibraryDB;Trusted_Connection=True;");
            });
        }
