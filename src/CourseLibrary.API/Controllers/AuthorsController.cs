...
namespace CourseLibrary.API.Controllers
{
    ...
    public class AuthorsController : ControllerBase
    {
            ...
            [FromQuery] AuthorsResourceParameters authorsResourceParameters)
        {
            ...
            var links = CreateLinksForAuthors(authorsResourceParameters, authorsFromRepo.HasNest, authorsFromRepo.HasPrevious);
            ...
            var shapedAuthorsWithLinks = shapedAuthors.Select(author =>
            {
                ...
                var authroLinks = CreateLinksForAuthor((Guid)authorAsDictionary["Id"], null);
                authorAsDictionary.Add("links", authroLinks);
